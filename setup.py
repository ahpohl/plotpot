...
print(path.join(here, 'plotpot/__version__.py'))

# set version here, also create corresponding git tag
version = '1.0.3'

with open(path.join(here, 'plotpot/__version__.py'), 'w') as f:
    header="""# coding: utf-8
# file generated by setuptools
